...
def makeAuthenticatedReq(restOfUrl):
  ...
  "reports": [
    {
      "url": "http://202.185.27.50:8080/index.php",
      "reported_at": 1410148800,
    ...
    try:
        r = urllib2.Request(ul, headers=http_header)
        req = urllib2.urlopen(r)
        try:
            resp=req.read()
            print "Response:",resp,"headers:",dict(req.info())
...
#makeAuthenticatedReq('search/events?url=www.hackforums.net&after=1273068828&before=1273068830')

makeAuthenticatedReq('events/ip/3098078721')
